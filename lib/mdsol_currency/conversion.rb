module Mdsol
  class Conversion
    ...
    def exchange_rate(location_uuid: nil, from_currency_uuid: nil, to_currency_uuid:)
      ...
      from_currency_uuid ||= Location.new(location_uuid).default_currency_uuid
      return 1 if from_currency_uuid == to_currency_uuid
      from_currency = Currency.new(from_currency_uuid)
      to_currency = Currency.new(to_currency_uuid)
    ...
    def find_exchange_rate(currency_uuid:)
      currency = Currency.new(currency_uuid)
